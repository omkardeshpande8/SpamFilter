...
class WSDParser2 {
	...
	public static void main(String[] args) throws Exception {
		...
		URL url = null;
		String path = "/home/omkar/WordNet-3.0/dict";
		try {
		...
		constructHashMaps("/home/omkar/Downloads/relesk/spam_training.txt", dict);
		constructHashMaps("/home/omkar/Downloads/relesk/ham_training.txt", dict);
	...
	public static void constructHashMaps(String path, IDictionary dict) throws IOException
	{
		...
		MaxentTagger tagger = new MaxentTagger("C:/Users/Aniket/Downloads/stanford-postagger-2015-04-20/stanford-postagger-2015-04-20/models/english-bidirectional-distsim.tagger");
	...
	{
		String testFileString = new Scanner(new File("D:/temp.txt")).useDelimiter("\\A").next();
